      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () async {
           ...
           await  profileController.getTermsPrivacy();
           await profileController.getMyQuiz();
          },
          child: ListView(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Image.asset(
                        ...
                        showDialog(
                            context: context,
                            builder: (context) => editDialog(context: context));
                      }),
                      15.widthBox
                    ],
                  ).animate().fadeIn(delay: 50.ms),
                  10.heightBox,
                  Divider(thickness: 1.2, height: 1, color: gry.withOpacity(0.4))
                      .animate()
                      .fadeIn(delay: (70).ms),
                  10.heightBox,
                  Row(
                  ...
                  Row(
                    ...
                    Get.to(() => QuickTechMyCourse(
                      enrollCourse:
                      profileController.profile.value.enrolledCourses ??
                          [],
                    ));
                  }),
                  Divider(
